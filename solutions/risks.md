...
**Риск 1: Некачественные или недостаточные данные**
**Описание:** ИИ не может работать без качественных данных
**Вероятность:** Высокая
**Влияние:** Критическое
...
**Риск 2: Неправильный выбор технологий**
**Описание:** Выбранные технологии не подходят для задачи
**Вероятность:** Средняя
**Влияние:** Высокое
...
**Описание:** ИИ-система работает медленно или нестабильно
**Вероятность:** Средняя
**Влияние:** Высокое
...
**Описание:** Сотрудники не хотят использовать ИИ
**Вероятность:** Высокая
**Влияние:** Критическое
...
**Описание:** В команде нет необходимых знаний и навыков
**Вероятность:** Высокая
**Влияние:** Высокое
...
**Риск 6: Неясные цели и ожидания**
**Описание:** Непонимание того, что должно получиться
**Вероятность:** Средняя
**Влияние:** Высокое
...
**Риск 7: Превышение бюджета**
**Описание:** Реальные затраты превышают планируемые
**Вероятность:** Средняя
**Влияние:** Высокое
...
**Риск 8: Долгая окупаемость**
**Описание:** ROI достигается позже планируемого
**Вероятность:** Средняя
**Влияние:** Среднее
...
**Риск 9: Конкуренция и быстрое устаревание**
**Описание:** Решение становится неактуальным
**Вероятность:** Низкая
**Влияние:** Среднее
...
**Риск 10: Утечка данных**
**Описание:** Компрометация конфиденциальной информации
**Вероятность:** Низкая
**Влияние:** Критическое
...
**Риск 11: Предвзятость алгоритмов**
**Описание:** ИИ принимает несправедливые решения
**Вероятность:** Средняя
**Влияние:** Высокое
...
**Риск 12: Социальный след**
**Описание:** Человеческий фактор влияет на объективность анализа
**Вероятность:** Высокая
**Влияние:** Высокое
...
**Риск 13: Отсутствие объективности в анализе**
**Описание:** Анализ искажается под влиянием предубеждений
**Вероятность:** Высокая
**Влияние:** Высокое
